...
var parseLineTests = []parseLineTest{
	...
	//	},
	{
		line: `Jan 1 00:00:00 local0 haproxy[2344]: 10.0.1.59 - - [02/Dec/2014:16:41:32 +0000] "GET /elb/check HTTP/1.1" 200 359 "" "" 5555 073 "front" "back" "server" 4995 0 0 5 5000 ---- 72 72 1 1 0 0 0 "" "" "" "ELB-HealthChecker/1.0" "Basic something"`,
		expected: HAProxyLogLine{
			ProcessId:           "2072",
			ClientIp:            "1.2.3.4",
			ClientPort:          "5555",
